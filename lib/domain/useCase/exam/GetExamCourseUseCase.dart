...
import '../../../data/serializer/exam/ExamCourceResponse.dart';

class GetExamCourseUseCase extends BaseUseCase {
  ...
  void getByTestDate(
    ...
    try {
      ...
      Uri uri = UriCreator.createUri(
          path: ExamApiRoutes.getTestIndexCourses, body: map);
      Logger.d(map);
      var response = await apiServiceImpl.post(uri);
      Logger.d(response.body);
      if (response.isSuccessful) {
        var examDetail = examCourceResponseFromJson(response.body);
